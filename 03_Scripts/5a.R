...
###DO#######
file.names <- list.files(path="HOBO Excels/5a/DO", pattern=".csv", full.names=TRUE)
...
file.names <- list.files(path="HOBO Excels/5a/SpC", pattern=".csv", full.names=TRUE)
...
####pH#####
file.names <- list.files(path="HOBO Excels/5a/pH", pattern=".xlsx", full.names=TRUE)
...
####Lily Box#######
file.names <- list.files(path="Lily Box/csv/5a", pattern=".csv", full.names=TRUE)
...
file.names <- list.files(path="Lily Box/dat/5a", pattern=".dat", full.names=TRUE)
...
h5a <- read_excel("//ad.ufl.edu/ifas/SFRC/Groups/Hydrology/Bradford_Forest_Project/Streams/Stream_H20_level/Calculated_Stage/Stream #5a.xlsx", 
                       skip = 1)
