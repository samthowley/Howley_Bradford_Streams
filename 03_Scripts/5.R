...
###DO#######
file.names <- list.files(path="HOBO Excels/5/DO", pattern=".csv", full.names=TRUE)
...
write_xlsx(DO_5_all, "//ad.ufl.edu/ifas/SFRC/Groups/Hydrology/Bradford_Forest_Project/Streams/Stream_chemistry/Format/5/DO.xlsx")

###SpC#####

file.names <- list.files(path="HOBO Excels/5/SpC", pattern=".csv", full.names=TRUE)
...
write_xlsx(SpC_5_all, "//ad.ufl.edu/ifas/SFRC/Groups/Hydrology/Bradford_Forest_Project/Streams/Stream_chemistry/Format/5/SpC.xlsx")

####pH#####
file.names <- list.files(path="HOBO Excels/5/pH", pattern=".xlsx", full.names=TRUE)
...
write_xlsx(pH_5_all, "//ad.ufl.edu/ifas/SFRC/Groups/Hydrology/Bradford_Forest_Project/Streams/Stream_chemistry/Format/5/pH.xlsx")

####Lily Box#######
file.names <- list.files(path="Lily Box/csv/5", pattern=".csv", full.names=TRUE)
...
file.names <- list.files(path="Lily Box/dat/5", pattern=".dat", full.names=TRUE)
...
write_xlsx(LB5_FDOM, "//ad.ufl.edu/ifas/SFRC/Groups/Hydrology/Bradford_Forest_Project/Streams/Stream_chemistry/Format/5/FDOM.xlsx")
...
write_xlsx(LB5_CO2, "//ad.ufl.edu/ifas/SFRC/Groups/Hydrology/Bradford_Forest_Project/Streams/Stream_chemistry/Format/5/CO2.xlsx")

S5<-left_join(S5, LB5_FDOM, by='Date')
S5<-left_join(S5, LB5_CO2, by='Date')

ggplot(S5, aes(x=Date))+
  geom_line(aes(y=FDOM), size=0.8)+
  geom_line(aes(y=CO2), size=0.8)
...
###Stage#####
h5 <- read_excel("//ad.ufl.edu/ifas/SFRC/Groups/Hydrology/Bradford_Forest_Project/Streams/Stream_H20_level/Calculated_Stage/Stream #5.xlsx", 
                       skip = 1)
...
write_xlsx(S5, "//ad.ufl.edu/ifas/SFRC/Groups/Hydrology/Bradford_Forest_Project/Masterfiles_latest/Stream Chemistry/5.xlsx")
