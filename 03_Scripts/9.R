...
###DO#######
file.names <- list.files(path="HOBO Excels/9/DO", pattern=".csv", full.names=TRUE)
...
file.names <- list.files(path="HOBO Excels/9/SpC", pattern=".csv", full.names=TRUE)
...
####pH#####
file.names <- list.files(path="HOBO Excels/9/pH", pattern=".xlsx", full.names=TRUE)
...
####Lily Box#######
file.names <- list.files(path="Lily Box/csv/9", pattern=".csv", full.names=TRUE)
...
file.names <- list.files(path="Lily Box/dat/9", pattern=".dat", full.names=TRUE)
...
h9 <- read_excel("//ad.ufl.edu/ifas/SFRC/Groups/Hydrology/Bradford_Forest_Project/Streams/Stream_H20_level/Calculated_Stage/Stream #9.xlsx", 
                       skip = 1)
...
write_xlsx(S9, "//ad.ufl.edu/ifas/SFRC/Groups/Hydrology/Bradford_Forest_Project/Masterfiles_latest/Stream Chemistry/9.xlsx")
