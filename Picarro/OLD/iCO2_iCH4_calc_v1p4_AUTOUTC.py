...
GUITitle='iCH4 & iCO2 calculator'
GUIWindowTitle='iCH4 & iCO2 calculator 20221007'
...
# offset computer time to UTC (-4/5 for EST, +1/+2 for Europe)
offsetUTC=0
...
analysistimeentrytitle = Label(root, anchor=W, text="time to include in math (min):")
analysistimeentrytitle.grid(row=4,column=0, columnspan=1, sticky=[E])
analysistimeentry= Entry(root,width=4)
analysistimeentry.insert(0,analysisTimeMinutes)
analysistimeentry.grid(row=4,column=1, columnspan=1, sticky=[W])
