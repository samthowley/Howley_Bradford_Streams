...
GUITitle='iCO2 iCH4 calculator'
GUIWindowTitle='iCO2 iCH4 calculator 20220706'
...
def askopenresultsfilename():
    ...
    if sampletimefilename:
        ...
        for row in sampletimes['SampleName']:  
            ...
            if len(CRDSdata)<5:
                print("not enough data found for :"+sampletimes['SampleName'][c1])
            else:
...
UTCoffsettitle = Label(root, anchor=W, text="Offset local time UTC : (-5 in winter, -4 in summer in Ontario)")
