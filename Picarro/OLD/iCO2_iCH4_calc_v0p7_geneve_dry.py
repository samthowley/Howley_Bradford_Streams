         ...
         if fileepochtime > firstsampletime-86400 and fileepochtime < lastsampletime+86400:
            try:
               ...
               for row in fd['TIME']:
                  ...
                  fd['HP_12CH4_dry'][c1],fd['HP_13CH4'][c1],fd['HP_Delta_iCH4_Raw'][c1],
                  fd['HR_12CH4_dry'][c1],fd['HR_13CH4'][c1],fd['HR_Delta_iCH4_Raw'][c1],
                  fd['12CO2_dry'][c1],fd['13CO2'][c1],fd['Delta_Raw_iCO2'][c1],
