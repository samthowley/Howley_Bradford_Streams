...
def MergeResults():
   ...
   resultswriter.writerow(['Date','Local_Time','Epoch_Time',
...
root = Tk()
root.title('iCH4 iCO2 results calculator 20190704')

#__________________________________LOGO&TITLE________________________________________

bigtitle = Label(root, anchor=W, font=('times', 20, 'bold'), fg='white',bg='blue', text="Geneve iCH4 & iCO2 calculator ")
...
UTCoffsettitle = Label(root, anchor=W, text="Offset local time UTC (-2 summer, -1 winter):")
UTCoffsettitle.grid(row=13,column=0, columnspan=1, sticky=[E])
UTCoffsetentry= Entry(root,width=4)
UTCoffsetentry.insert(0,"-2")
