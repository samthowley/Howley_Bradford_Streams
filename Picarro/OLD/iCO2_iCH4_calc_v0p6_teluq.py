   ...
   if sampletimefilename:
      ...
      for row in sampletimes['SampleName']:
         ...
         while sampleepochtime+stabilizesec > iCH4data['Epoch_Time'][c2]:
            ...
            outletValveStart.append(iCH4data['OutletValve'][c2])
            c2=c2+1            
         ...
         if len(y12CH4s)>2:
            ...
            OutletValvemean=numpy.mean(outletValveStart)
...
bigtitle = Label(root, anchor=W, font=('times', 20, 'bold'), fg='white',bg='blue', text="TELUQ iCH4 & iCO2 calculator ")
